        ...
        <form role="form" method="post" action="{{route('category.update', ['category' => $category->id])}}">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="title">Изменить категорию</label>
                    <input name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="{{$category->title}}">
                </div>
            </div>
                <!-- /.card-body -->
