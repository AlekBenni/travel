        ...
        <form role="form" method="post" action="{{route('contact.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input name="title" type="text" class="form-control @error('name') is-invalid @enderror" id="title" placeholder="Введите приветствие">
                </div>

                <div class="form-group">
                    <label for="description">Что-то</label>
                    <textarea id="description" name="description" class="form-control @error('title') is-invalid @enderror" rows="3" placeholder="Введите что-то"></textarea>
                </div>
